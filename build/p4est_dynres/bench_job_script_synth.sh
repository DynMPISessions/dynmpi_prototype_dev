...
echo "running test nr. 1 with parameters: -np 28 -c 200 -l 224  -m s+ -n 28 -f 10 -b 1"
prterun -np 28 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 1
...
echo "running test nr. 2 with parameters: -np 28 -c 200 -l 224  -m s+ -n 28 -f 10 -b 0"
prterun -np 28 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 0
...
echo "running test nr. 3 with parameters: -np 56 -c 200 -l 224  -m s+ -n 28 -f 10 -b 1"
prterun -np 56 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 1
...
echo "running test nr. 4 with parameters: -np 56 -c 200 -l 224  -m s+ -n 28 -f 10 -b 0"
prterun -np 56 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 0
...
echo "running test nr. 5 with parameters: -np 84 -c 200 -l 224  -m s+ -n 28 -f 10 -b 1"
prterun -np 84 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 1
...
echo "running test nr. 6 with parameters: -np 84 -c 200 -l 224  -m s+ -n 28 -f 10 -b 0"
prterun -np 84 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 0
...
echo "running test nr. 7 with parameters: -np 112 -c 200 -l 224  -m s+ -n 28 -f 10 -b 1"
prterun -np 112 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 1
...
echo "running test nr. 8 with parameters: -np 112 -c 200 -l 224  -m s+ -n 28 -f 10 -b 0"
prterun -np 112 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 0
...
echo "running test nr. 9 with parameters: -np 140 -c 200 -l 224  -m s+ -n 28 -f 10 -b 1"
prterun -np 136 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 1
...
echo "running test nr. 10 with parameters: -np 140 -c 200 -l 224  -m s+ -n 28 -f 10 -b 0"
prterun -np 136 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 0
...
echo "running test nr. 11 with parameters: -np 168 -c 200 -l 224  -m s+ -n 28 -f 10 -b 1"
prterun -np 164 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 1
...
echo "running test nr. 12 with parameters: -np 168 -c 200 -l 224  -m s+ -n 28 -f 10 -b 0"
prterun -np 164 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 0
...
echo "running test nr. 13 with parameters: -np 196 -c 200 -l 224  -m s+ -n 28 -f 10 -b 1"
prterun -np 196 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 1
mkdir ${DYNMPI_BASE}/build/p4est_dynres/applications/output/synth/nstart14_b
...
echo "running test nr. 14 with parameters: -np 196 -c 200 -l 224  -m s+ -n 28 -f 10 -b 0"
prterun -np 196 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 200 -l 224  -m s+ -n 28 -f 10 -b 0
mkdir ${DYNMPI_BASE}/build/p4est_dynres/applications/output/synth/nstart14_nb
...
mkdir ${DYNMPI_BASE}/build/p4est_dynres/applications/output/prrte/nstart14_nb
...
echo "running test nr. 15 with parameters: -np 28 -c 120 -l 224  -m i+ -n 28 -f 10 -b 1"
prterun -np 28 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 120 -l 224  -m i+ -n 28 -f 10 -b 0
...
echo "running test nr. 16 with parameters: -np 28 -c 120 -l 224  -m i+ -n 28 -f 10 -b 0"
prterun -np 28 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 120 -l 224  -m i+ -n 28 -f 10 -b 0
...
echo "running test nr. 17 with parameters: -np 228 -c 120 -l 28 -m i_ -n 28 -f 10 -b 1"
prterun -np 228 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 120 -l 28  -m i_ -n 28 -f 10 -b 1
...
echo "running test nr. 18 with parameters: -np 228 -c 120 -l 28  -m i+ -n 28 -f 10 -b 0"
prterun -np 228 --mca btl_tcp_if_include eth0 --hostfile ${DYNMPI_BASE}/hostfile-${SLURM_JOB_ID}.txt -x LD_LIBRARY_PATH -x DYNMPI_BASE /opt/hpc/build/p4est_dynres/applications/build/SWE_p4est_benchOmpidynresSynthetic_release -c 120 -l 28  -m i_ -n 28 -f 10 -b 0
