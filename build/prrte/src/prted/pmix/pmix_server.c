...
void pmix_server_start(void)
{
    ...
    prte_rml.recv_buffer_nb(PRTE_NAME_WILDCARD, PRTE_RML_TAG_MALLEABILITY, PRTE_RML_PERSISTENT,
...
PRTE_CLASS_INSTANCE(prte_res_change_t, prte_list_item_t, NULL, NULL);
